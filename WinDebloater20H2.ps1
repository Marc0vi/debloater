...
$Button = [System.Windows.MessageBoxButton]::OuiNonAnnuler
$ErrorIco = [System.Windows.MessageBoxImage]::Error
$Ask = 'Voulez-vous éxécuter en tant qu'administrateur ?
        Select "Oui" pour lancer en tant qu'administrateur
        Select "Non" pour ne pas lancer en tant qu'administrateur
        
        Select "Annuler" pour arrêter l'exécution du script.'

If (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]'Administrator')) {
    $Prompt = [System.Windows.MessageBox]::Show($Ask, "Lancer en tant qu'administrateur ?", $Button, $ErrorIco) 
    Switch ($Prompt) {
        #This will debloat Windows 10
        Yes {
            Write-Host "Vous n'avez pas lancé ce script en tant qu'administrateur, ce script va s'auto élever pour continuer en tant qu'administrateur."
...
$Label1.text                     = "Installation Logicielle"
...
$installchoco.text               = "Installer Chocolatey"
...
$powertoys.text                  = "Package Atelier"
$powertoys.width                 = 150
$powertoys.height                = 30
...
$Label2.text                     = "(Chocolatey Requis pour l'installation)"
...
$Label3.text                     = "Utilitaires système"
...
$essentialtweaks.text            = "Utilitaires Essentiels"
...
$backgroundapps.text             = "Application en arrière plan"
...
$Label5.text                     = "- Le Prompt UAC est désactivé"
...
$Label6.text                     = "- Désactiver Windows Defender"
...
$Label7.text                     = "- Désactive les mises à jour Defender"
...
$Label8.text                     = "- Disactive le scan de Windows Malware"
...
$Label9.text                     = "- Désactive Meltdown Flag"
...
$Label10.text                    = "- Active le Prompt UAC"
...
$Label11.text                    = "- Active Windows Defender"
...
$Label12.text                    = "- Active le scan Windows Malware"
...
$Label13.text                    = "- Active Meltdown Flag"
...
$defaultwindowsupdate.text       = "Paramètres par défaut"
...
$securitywindowsupdate.text      = "Mises à jour de sécurité seulement"
...
$Label16.text                    = "Je recommande seulement les mises à jour de sécurité."
...
$Label17.text                    = "- Retarde les mises à jour des fonctionnalités jusqu'à 3 ans"
...
$Label18.text                    = "- Retarde les mises à jour de sécurité de 4 jours"
...
$Label19.text                    = "- Définit le temps actif maximum"
...
$Label21.text                    = "- Cela modifiera votre système et je vous recommande de sauvegarder toutes les données avant d'exécuter !"
...
$Label22.text                    = "(Pas sure !?... Appliquez juste les Utilitaires Essentiels)"
...
$Label23.text                    = "- Besoin de restorer action center, cortana, etc.? Lancez le script de restuaration : https://youtu.be/H2ydDcqRZyM"
...
$powertoys.Add_Click({ 
    Write-Host "Installation du package Atelier"
	Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://chocolatey.org/install.ps1'))
	choco install chocolatey-core.extension -y
    choco install Brave Ccleaner Thunderbird notepadplusplus 7zip mpc-be vlc -y
	$wshell.Popup("Operation Completed",0,"Done",0x0)
})
...
$essentialtweaks.Add_Click({ 
    ...
    Write-Host "Désactivation de la Telemetrie..."
